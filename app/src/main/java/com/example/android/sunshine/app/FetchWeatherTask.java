...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.lp_key_temperature),
                mContext.getString(R.string.lp_default_temperature));

        if (!unitType.equals(mContext.getString(R.string.lp_default_temperature))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (true) {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        // Otherwise, insert it using the content resolver and the base URI
            ...
            Uri insertedUri = mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, cv);
