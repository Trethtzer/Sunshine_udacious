...
/**
 * Created by Trethtzer on 18/02/2017.
 */
...
public class SunshineService extends IntentService {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted = this.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, contentValues);
            }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        // Otherwise, insert it using the content resolver and the base URI
            ...
            Uri insertedUri = this.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, cv);
